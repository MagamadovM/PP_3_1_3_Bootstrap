...
public class UserDaoImp implements UserDao {
   ...
   @Override
   public Optional<User> findOptionalUserByLogin(String login) {
      try {
         return Optional.ofNullable(
                 (User)entityManager.createQuery("SELECT u FROM User u LEFT JOIN FETCH u.roles WHERE u.login = :login")
